...
const Footer = () => {
  return (
    <footer className="px-4 py-8 bg-gray-100 text-gray-600 shadow-md">
      <div className="container flex flex-wrap items-center justify-center mx-auto space-y-4 sm:justify-between sm:space-y-0">
        <div className="flex flex-row pr-3 space-x-4 sm:space-x-8">
          ...
          <ul className="flex flex-wrap items-center space-x-4 sm:space-x-8">
            <li>
              <Link to="/" rel="noopener noreferrer">Terms of Use</Link>
            </li>
            <li>
        ...
        <ul className="flex flex-wrap pl-3 space-x-4 sm:space-x-8">
          <li>
            <Link to="/" rel="noopener noreferrer">Instagram</Link>
          </li>
          <li>
            <Link to="/" rel="noopener noreferrer">Facebook</Link>
          </li>
          <li>
            <Link to="/" rel="noopener noreferrer">Twitter</Link>
          </li>
        </ul>
      </div>
  </footer>
